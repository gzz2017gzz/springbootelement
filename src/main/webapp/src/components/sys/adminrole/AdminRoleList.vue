...
<template>
  <div>
    ...
    <el-table :data="dataList" v-loading="loading" element-loading-text="正在加载......" style="width: 100%" border size="small">
    ...
    <FuncRreeRef ref="FuncTreeRef"/>
    <DeptTreeRef ref="DeptTreeRef"/>
  </div>
</template>
<script>
  import AdminRoleDialog from './AdminRoleDialog.vue';
  import FuncTreeRef from './FuncTreeRef.vue';
  import DeptTreeRef from './DeptTreeRef.vue';
  ...
  export default {
    ...
    components: {AdminRoleDialog, FuncTreeRef, DeptTreeRef}
  }
</script>
<style></style>
